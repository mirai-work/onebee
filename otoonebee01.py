...
class TwinBeeFinal:
    def __init__(self):
        pyxel.init(WIDTH, HEIGHT, title="ONEBEE: ULTIMATE EDITION")
        self.setup_sounds() 
    ...
    def setup_sounds(self):
        # --- SE (効果音) ---
        pyxel.sounds[0].set("a2a1c1", "p", "777", "vff", 5)          # ショット
        pyxel.sounds[1].set("c2c1g1g0", "n", "7777", "vfff", 10)    # 爆発
        pyxel.sounds[2].set("e3g3e4g4", "s", "6666", "vvvv", 10)    # ベル
        pyxel.sounds[3].set("g2g3g4", "t", "777", "vvv", 10)        # パワーアップ
        pyxel.sounds[8].set("c3g2e2c2", "p", "6666", "vvvv", 40)    # ゲームオーバー
        pyxel.sounds[9].set("c3c2c1", "s", "777", "vvv", 20)        # ダメージ
        ...
        pyxel.sounds[5].set(n5, "n", "5"*16, "v"*16, 20)
        # 6: 通常ボス (16音)
        ...
        # --- ファイナルボス専用素材 (修正済み) ---
        # n10の「ef」を「e2f2」に修正しました
        n10 = "c2c2e2f2g2g2f2e2c2c2g1g1c2c2e2f2g2g2a2b2c3c3b2a2"
        pyxel.sounds[10].set(n10, "t", "7"*24, "v"*24, 10) # 音数を24音に調整
        ...
        # 12: 緊迫ドラム (8音)
        n12 = "f0f1f0f1f0f0f1r"
        pyxel.sounds[12].set(n12, "n", "7"*8, "v"*8, 8)

        # --- Music設定 ---
        pyxel.musics[0].set([4], [5], [], [])   # 0: ステージBGM
        pyxel.musics[1].set([6], [5], [], [])   # 1: 通常ボス
        pyxel.musics[2].set([7], [5], [], [])   # 2: ステージクリア
        pyxel.musics[3].set([7], [], [], [])    # 3: エンディング
        pyxel.musics[4].set([10], [11], [12], []) # 4: ファイナルボス
